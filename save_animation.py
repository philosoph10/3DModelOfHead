...
def save_animation(model, filename="demo.mp4", fps=20, duration=10):
    """Saves the rotating model animation as a video."""
    ...
    ani.save(filename, fps=fps, dpi=100)  # Save as MP4
    print(f"Animation saved as {filename}")

# Run and save animation
model = Model("assets/african_head.obj")
save_animation(model, filename="assets/demo.mp4")
